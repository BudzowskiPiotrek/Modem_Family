...
public class Common {
	...
	private static final Color L_ACCENT = new Color(70, 130, 180);
	...
	private static final Color D_ACCENT = new Color(100, 160, 210);
	
	private static final Color C_DANGER = new Color(220, 53, 69);
	...
	public static Color getAccent() { return isDarkMode ? D_ACCENT : L_ACCENT; }
	public static Color getDanger() { return C_DANGER; }
	...
	public static Color getHoverColor(boolean isDanger, boolean isAccent) {
		if (isDanger) return new Color(200, 40, 50);
		if (isAccent) return isDarkMode ? new Color(60, 100, 140) : new Color(235, 245, 255);
